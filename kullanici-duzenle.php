...
<body>
 ...
 ?>
        ...
        <div class="main-content">
                        ...
                        <ul class="notification-area pull-right">
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu bell-notify-box notify-box">
                                    <span class="notify-title">3 yeni bidliriminiz var <a href="#">view all</a></span>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu notify-box nt-enveloper-box">
                                    <span class="notify-title">3 yeni bildiriminiz var <a href="#">view all</a></span>
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">   AnasayfaS</a></li>
            ...
            <?php 
            include("yonetici/kayit/duzenle/kullaniciform.php");
            ?>
